...
return [
    ...
    'description' => 'Boardgame Plays & Statistics Platform API - A comprehensive API for managing board game information, plays, and player statistics.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for token-based authentication. You can obtain a token by logging in via the <code>POST /api/v1/auth/login</code> endpoint or registering via <code>POST /api/v1/auth/register</code>. Include the token in the Authorization header as: <code>Bearer {YOUR_AUTH_TOKEN}</code>.',
    ],
